...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (user) setProfile({ fullName: user.fullName || '', phone: '' });
  }, [user]);
    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleProfileSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={profileLoading} className="px-5 py-2 brand-gradient text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-50">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={passwordLoading} className="px-5 py-2 brand-gradient text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-50">
